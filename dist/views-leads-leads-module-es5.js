(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-leads-leads-module"], {
    ...
    function Btx(module, __webpack_exports__, __webpack_require__) {
      ...
      var LeadsService = /*#__PURE__*/function () {
        ...
        _createClass(LeadsService, [{
          ...
          key: "createProspect",
          value: function createProspect(lead_id) {
            return this.httpClient.post(this.apiURL + '/lead/create-prospect', lead_id, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (response) {
              console.log(response);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
          }
        }, {
      ...
      LeadsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
        ...
        _createClass(LeadsImportComponent, [{
          ...
          value: function submit() {
            ...
            for (var i = 0, len = this.csvRecords.length; i < len; i++) {
              ...
              this.leadsService.store(this.csvRecords[i]).subscribe(function (res) {
                if (!res.success) {
                  stopCreate = true;
                }
      ...
      var LeadsIndexComponent = /*#__PURE__*/function () {
        ...
        _createClass(LeadsIndexComponent, [{
          ...
          value: function onClick(pageNo) {
            ...
            this.leadService.getPage(pageNo, this.pageItems, this.search_text).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
      ...
      var LeadsCreateComponent = /*#__PURE__*/function () {
        ...
        _createClass(LeadsCreateComponent, [{
          ...
          value: function submit() {
            ...
            if (this.isSkipcompany) {
              ...
              this.leadsService.searchCompany(company_name).subscribe(function (res) {
                if (res.success) {
                  _this13.alertHeader = res.data;
                  _this13.alertBody = _this13.message;
                  _this13.alretType = 'company';
          ...
          value: function create() {
            ...
            var skipModal = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
          ...
          value: function verify() {
            ...
            this.leadsService.store(this.form.value).subscribe(function (res) {
              _this15.id = res.data.id;
            }, function (error) {
              _this15.alertBody = error.message || 'Failed';

              _this15.dangerModal.show();
            }, function () {
              _this15.router.navigateByUrl('leads/' + _this15.id + '/verify');
            });
          }
        }, {
          key: "searchName",

...
export class ManufacturersService {
  ...
  getAll(pageItems,search_text): Observable<any[]> {
    let query = '/manufacturer?page_items=' + pageItems + '&search_text=' + search_text;
  ...
  find(id): Observable<any> {
    return this.httpClient.get(this.apiURL + '/manufacturer/' + id)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  update(data, id): Observable<any> {
    return this.httpClient.put(this.apiURL + '/manufacturer/' + id, JSON.stringify(data), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  delete(id){
    return this.httpClient.delete<any>(this.apiURL + '/manufacturer/' + id, this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }

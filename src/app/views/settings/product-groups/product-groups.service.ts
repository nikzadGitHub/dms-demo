...
export class ProductGroupsService {
  ...
  getAll(pageItems,search_text): Observable<any[]> {
    let query = '/product-group?page_items=' + pageItems + '&search_text=' + search_text;
  ...
  find(id): Observable<any> {
    return this.httpClient.get(this.apiURL + '/product-group/' + id)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  update(data, id): Observable<any> {
    return this.httpClient.put(this.apiURL + '/product-group/' + id, JSON.stringify(data), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  delete(id){
    return this.httpClient.delete<any>(this.apiURL + '/product-group/' + id, this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }

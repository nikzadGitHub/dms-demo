...
export class CareAreasService {
  ...
  getAll(pageItems,search_text): Observable<any[]> {
    let query = '/care-area?page_items=' + pageItems + '&search_text=' + search_text;
  ...
  find(id): Observable<any> {
    return this.httpClient.get(this.apiURL + '/care-area/' + id)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  update(data, id): Observable<any> {
    return this.httpClient.put(this.apiURL + '/care-area/' + id, JSON.stringify(data), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  delete(id){
    return this.httpClient.delete<any>(this.apiURL + '/care-area/' + id, this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }

...
export class OpcsService {
  ...
  getAll(pageItems,search_text): Observable<any[]> {
    let query = '/opc?page_items=' + pageItems + '&search_text=' + search_text;
  ...
  find(id): Observable<any> {
    return this.httpClient.get(this.apiURL + '/opc/' + id)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  update(data, id): Observable<any> {
    return this.httpClient.put(this.apiURL + '/opc/' + id, JSON.stringify(data), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  delete(id){
    return this.httpClient.delete<any>(this.apiURL + '/opc/' + id, this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
